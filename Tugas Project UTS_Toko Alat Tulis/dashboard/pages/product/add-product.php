        ...
        <div class="card">
            <div class="container-fluid px-5 py-2">
                ...
                <form action="" method="POST">
                    ...
                    <!-- select jenis_produk -->
                    <div class="mb-3">
                        <label for="merk" class="form-label">Product Type</label>
                        <select class="form-select" aria-label="Default select example" name="merk_id" id="merk" required>
                            <option value="">Select Product Type</option>
                            <?php foreach ($merk as $jp) : ?>
