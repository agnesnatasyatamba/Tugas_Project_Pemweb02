    ...
    <div class="mask" style="background-color: rgba(0,0,0, 0.7);">
        <div class="d-flex justify-content-center align-items-center h-100">
            <div class="text-primary-color">
                <h1 class="mb-2">Agnes.Store</h1>
                <h4 class="mb-4" style="max-width: 800px;">!!!Semua Kebutuhan Kantor Hingga Sekolah Dengan Harga Termurah Ada Di Sini!!!</h4>
                <a class="btn btn-secondary-color btn-lg" href="#products" role="button">Detail Produk</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row justify-content-center text-center">
            <div class="col-md-8 col-lg-6">
                <div class="header">
                    ...
                    <h2 class="text-secondary-color" style="font-weight: 900;">Produk Terlaris </h2>
                </div>
            </div>
        </div>
        <div class="row">
