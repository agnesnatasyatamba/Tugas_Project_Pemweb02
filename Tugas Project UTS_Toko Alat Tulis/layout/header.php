        ...
        <div class="container-fluid col-xl-8">
            ...
            <div class="collapse navbar-collapse" id="navbarToggleExternalContent">
                ...
                <a class="navbar-brand mt-2 mt-lg-0" href="index.php">
                    <img src="assets/img/logo.jpg" height="50" alt="MDB Logo" loading="lazy" />
                </a>
                <!-- Left links -->
            ...
            <div class="d-flex align-items-center">
                <!-- Icon -->
                <a class="text-reset me-3" href="checkout.php">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end bg-secondary-color" aria-labelledby="navbarDropdownMenuAvatar">
                        <li>
                            <a class="dropdown-item text-primary-color py-2" href="dashboard/pages/product/product.php">Dashboard</a>
                        </li>
                    </ul>
                </div>
            </div>
